...
declare global {
  ...
  interface Electron {
    ...
    updateThemePreviewBounds: (themeId: string, bounds: { x: number; y: number; width: number; height: number }) => Promise<void>;
    onThemePreviewElementClicked: (cb: (selectors: string[]) => void) => () => Electron.IpcRenderer;

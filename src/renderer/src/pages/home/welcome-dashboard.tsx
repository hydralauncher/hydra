...
export function WelcomeDashboard() {
  ...
  const friendsOnline = [
    ...
    },
    {
      ...
      avatar: "https://avatar.iran.liara.run/public/boy?username=MR_ChiefBigTotem",
    },
  ];
        ...
        <div className="welcome-dashboard__column">
          ...
          <div className="welcome-dashboard__card welcome-dashboard__card--big welcome-dashboard__card--trophies">
            <div className="welcome-dashboard__card-header">
              ...
              <span className="welcome-dashboard__meta">
                {t("total", { defaultValue: "Total" })}: {stats.totalTrophies.toLocaleString()}
              </span>
            </div>

            <div className="welcome-dashboard__trophies-row">
              <div className="welcome-dashboard__trophy-item">
                <div className="welcome-dashboard__trophy-badge welcome-dashboard__trophy-badge--platinum">🏆</div>
                <span className="welcome-dashboard__trophy-count">{stats.platinum}</span>
              </div>
              <div className="welcome-dashboard__trophy-item">
                <div className="welcome-dashboard__trophy-badge welcome-dashboard__trophy-badge--gold">🥇</div>
                <span className="welcome-dashboard__trophy-count">{stats.gold}</span>
              </div>
              <div className="welcome-dashboard__trophy-item">
                <div className="welcome-dashboard__trophy-badge welcome-dashboard__trophy-badge--silver">🥈</div>
                <span className="welcome-dashboard__trophy-count">{stats.silver}</span>
              </div>
              <div className="welcome-dashboard__trophy-item">
                <div className="welcome-dashboard__trophy-badge welcome-dashboard__trophy-badge--bronze">🥉</div>
            ...
            <div className="welcome-dashboard__level-footer">
              ...
              <span className="welcome-dashboard__level-percent">{stats.levelProgress}%</span>
            </div>
          </div>
          ...
          <div className="welcome-dashboard__card welcome-dashboard__card--small welcome-dashboard__card--controller">
            <div className="welcome-dashboard__controller-icon-wrapper">
              ...
              <svg className="welcome-dashboard__controller-svg" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="welcome-dashboard__controller-info">
              <span className="welcome-dashboard__controller-title">DualSense Wireless Controller</span>
          ...
          <div className="welcome-dashboard__card welcome-dashboard__card--small welcome-dashboard__card--storage">
            <div className="welcome-dashboard__card-header">
              <div className="welcome-dashboard__card-title-group">
                ...
                <h3 className="welcome-dashboard__card-title">Console Storage</h3>
              </div>
            ...
            <div className="welcome-dashboard__storage-content">
              <div className="welcome-dashboard__storage-meta">
                ...
                <span className="welcome-dashboard__storage-label">Free space</span>
                <span className="welcome-dashboard__storage-value">47.32 GB</span>
              </div>
              <div className="welcome-dashboard__storage-bar">
                <div className="welcome-dashboard__storage-segment welcome-dashboard__storage-segment--blue" style={{ width: '65%' }} />
                <div className="welcome-dashboard__storage-segment welcome-dashboard__storage-segment--purple" style={{ width: '15%' }} />
                <div className="welcome-dashboard__storage-segment welcome-dashboard__storage-segment--orange" style={{ width: '8%' }} />
              </div>
            </div>
          </div>
          ...
          <div className="welcome-dashboard__card welcome-dashboard__card--big welcome-dashboard__card--store">
            ...
            <div className="welcome-dashboard__store-content">
              ...
              <div className="welcome-dashboard__store-details">
                <h4 className="welcome-dashboard__store-title">RISE OF THE RONIN</h4>
        ...
        <div className="welcome-dashboard__column">
          ...
          <div className="welcome-dashboard__card welcome-dashboard__card--big welcome-dashboard__card--media">
            ...
            <div className="welcome-dashboard__media-footer">
              <span className="welcome-dashboard__media-tag">Latest Captures</span>
            </div>
          </div>
          ...
          <div className="welcome-dashboard__card welcome-dashboard__card--small welcome-dashboard__card--friends">
            <div className="welcome-dashboard__card-header">
              <div className="welcome-dashboard__card-title-group">
                ...
                <h3 className="welcome-dashboard__card-title">Online Friends</h3>
              </div>

...
export function ImageCropModal({
  ...
  }, [visible, outputWidth, outputHeight]);
      ...
      <div className="image-crop-modal">
        <div className="image-crop-modal__stage">
          ...
          >
            ...
            <div
              className={`image-crop-modal__grid${
                showGrid ? " image-crop-modal__grid--visible" : ""
              }`}
              aria-hidden="true"
            >
              <span className="image-crop-modal__grid-line image-crop-modal__grid-line--v1" />
              <span className="image-crop-modal__grid-line image-crop-modal__grid-line--v2" />
              <span className="image-crop-modal__grid-line image-crop-modal__grid-line--h1" />
              <span className="image-crop-modal__grid-line image-crop-modal__grid-line--h2" />
            </div>
          </button>

          <div
            className="image-crop-modal__toolbar"
            onPointerDown={(event) => event.stopPropagation()}
          >
            <button
              type="button"
              className={`image-crop-modal__icon-button${
                gridPinned ? " image-crop-modal__icon-button--active" : ""
              }`}
            ...
            <span className="image-crop-modal__toolbar-divider" />
            ...
            <span className="image-crop-modal__zoom-percent">
              {Math.round(zoom * 100)}%
            </span>

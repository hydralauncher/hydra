...
class TorrentDownloader:
    ...
    async def start_download(self, magnet: str, save_path: str):
        ...
        try:
            def _get_status():
                ...
                return {
                    ...
                    'status': status.state,
                    'bytesDownloaded': int(progress * total_size) if total_size > 0 else status.all_time_download,
                }

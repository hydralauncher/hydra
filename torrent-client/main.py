...
class TorrentManager:
    def __init__(self, torrent_port, read_sock_path, write_sock_path):
        ...
        self.read_sock_path = read_sock_path
        self.write_sock_path = write_sock_path
    ...
    def get_eta(self, status):
        ...
        return (remaining_bytes / status.download_rate) * 1000 if remaining_bytes >= 0 and status.download_rate > 0 else 1
